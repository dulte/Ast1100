...
class engine:
    def __init__(self, sideSize, holeSize, temp,interval,steps,number_of_particles):
    ...
    def print_press(self):
        ...
        print "Numerical Pressure: " , (self.force_on_top/(self.L**2))/self.steps
    ...
    def launch(self, numberOfBoxes, burnTime, launch_step):
        ...
        x = np.linspace(0,time, len(launcher_vel))
        plt. xlabel("Time[s]")
...
if __name__ == "__main__":
	...
	e = engine(L,H,T,interval,steps,numb_part)
